...
async def get_contacts(message: types.Message):
    ...
    await message.answer(f"Конечно! Вот ссылка для оплаты:\n\n{payment.create_payment(callback, message.from_user.username)},\n\nПосле оплаты ты можешь связаться с ответственным за заказы: @souvenir\_perfume\_order и договориться о способе получения _(самовывоз метро Таганская, Москва и доставка по России)_, а так же обговорить интересующие тебя вопросы и пожелания касательно аромата\n\n_Срок изготовления 2-5 дней_",
